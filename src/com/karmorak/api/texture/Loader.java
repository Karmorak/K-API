package com.karmorak.api.texture;
...
public abstract class Loader {
	...
	protected final Sprite[] textures;
	int curT = 0;
	...
	public Loader(String id, Sprite[] s, float MaxTime) {
	...
	public Loader(Sprite[] s, float MaxTime, int... list) {
		timeSince = new float[s.length];
		maxT = new float[s.length];
		for(int i = 0; i < s.length; i++) {
			timeSince[i] = 0;
	...
	public Loader(Sprite[] s, float[] times, int... list) {		
		timeSince = new float[s.length];		
